...
- Chapter 4 (Algae Blooms case study)
    + Text files with the data mentioned on page 195 (please note that it is much easier to load the data directly from the book web page as mentioned in the book)
        - [Analysis.txt](http://www.dcc.fc.up.pt/~ltorgo/DMwR2/Data/Analysis.txt)
        - [Eval.txt](http://www.dcc.fc.up.pt/~ltorgo/DMwR2/Data/Eval.txt)
        - [Sols.txt](http://www.dcc.fc.up.pt/~ltorgo/DMwR2/Data/Sols.txt)
